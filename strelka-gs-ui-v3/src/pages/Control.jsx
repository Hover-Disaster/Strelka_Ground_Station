...
const Control = () => {
  ...
  const handleStreamFreqInputChange = (e) => {
    setStreamFreq(e.target.value);
  };
  // Function to handle the toggle event
  const handleDataStreamingSwitchToggle = () => {
    updateSystemState({
      dataStreamingEnabled: !systemState.dataStreamingEnabled,
      streamFrequency: parseFloat(streamFreq),
    });
  ...
  const handleGPSTrackingSwitchToggle = () => {
    updateSystemState({
      gpsTrackingEnalbed: !systemState.gpsTrackingEnalbed,
    });
  };
              ...
              >
                ...
                <td>
                  <input
                    ...
                    checked={systemState.gpsTrackingEnalbed}
              ...
              >
                ...
                <td>
                  <input
                    ...
                    type="number"
                    placeholder="Enter stream frequency"
                    aria-label="stream-freq-input"
                    onChange={handleStreamFreqInputChange}
                  ></input>
                </td>
                <td>
                  <input
                    ...
                    checked={systemState.dataStreamingEnabled}
